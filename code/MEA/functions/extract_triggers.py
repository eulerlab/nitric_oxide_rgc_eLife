...
# DETECT ONSETS
##############################
def _detect_onsets_filtered(data, threshold=270e+3):
...
# EXTRACT
##############################
def extract(input_path=None, dtype='uint16', nb_channels=256, channel_id=126, output_path=None,threshold=50e+3):
    ...
    indices = _detect_onsets(data,threshold)
