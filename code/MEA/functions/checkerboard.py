...
class Checkerboard:
    ...
    def __init__(self, nb_checks_x, nb_checks_y, binary_source_path, rig_nb, repetitions, triggers):

        assert os.path.isfile(binary_source_path)

        self._nb_checks_x = nb_checks_x
        self._nb_checks_y = nb_checks_y
    ...
    def get_image_shape(self):
        ...
        shape = (self._nb_checks_x, self._nb_checks_y)
    ...
    def get_image(self, image_nb):
        ...
        for i in range(0, self._nb_checks_x):
            for j in range(0, self._nb_checks_y):
                bit_nb = (self._nb_checks_x * self._nb_checks_y * image_nb) + (self._nb_checks_x * i) + j
